...
func seedAggProducts(t *testing.T, db *engine.DB) {
	t.Helper()
...
func TestAvg(t *testing.T) {
	...
	avg, err := engine.NewQuery[AggProduct](db).Avg(ctx, "price")
...
func TestAvg_WithFilter(t *testing.T) {
	...
	avg, err := engine.NewQuery[AggProduct](db, where.Field("category").Eq("X")).Avg(ctx, "price")
	require.NoError(t, err)
...
func TestSum(t *testing.T) {
	...
	sum, err := engine.NewQuery[AggProduct](db).Sum(ctx, "price")
	require.NoError(t, err)
...
func TestMin(t *testing.T) {
	...
	min, err := engine.NewQuery[AggProduct](db).Min(ctx, "price")
	require.NoError(t, err)
...
func TestMax(t *testing.T) {
	...
	max, err := engine.NewQuery[AggProduct](db).Max(ctx, "price")
	require.NoError(t, err)
...
func TestScalarAggregate_IgnoresLimitSkipSort(t *testing.T) {
	...
	qs := engine.NewQuery[AggProduct](db).Limit(2).Skip(1).Sort("price", engine.Desc)
...
func TestGroupBy(t *testing.T) {
	...
	var stats []CatStats
	err := engine.NewQuery[AggProduct](db).GroupBy("category").Into(ctx, &stats)
	require.NoError(t, err)
...
func TestGroupBy_MultiKey(t *testing.T) {
	...
	var stats []Stats
	err := engine.NewQuery[AggProduct](db).GroupBy("category", "region").Into(ctx, &stats)
	require.NoError(t, err)
...
func TestGroupBy_SortByKey(t *testing.T) {
	...
	var asc []Stats
	err := engine.NewQuery[AggProduct](db).Sort("category", engine.Asc).
	...
	var desc []Stats
	err = engine.NewQuery[AggProduct](db).Sort("category", engine.Desc).
...
func TestGroupBy_SortByAgg(t *testing.T) {
	...
	var stats []Stats
	err := engine.NewQuery[AggProduct](db).
		GroupBy("category").
...
func TestGroupBy_Limit(t *testing.T) {
	...
	var stats []Stats
	err := engine.NewQuery[AggProduct](db).Sort("category", engine.Asc).Limit(1).
...
func TestGroupBy_SortByNonKey_Error(t *testing.T) {
	...
	var stats []Stats
	err := engine.NewQuery[AggProduct](db).Sort("price", engine.Asc).
		GroupBy("category").Into(ctx, &stats)
	require.Error(t, err)
...
func TestProject(t *testing.T) {
	...
	err := engine.NewQuery[AggProduct](db).Sort("price", engine.Asc).Project(ctx, &summaries)
	require.NoError(t, err)
...
func TestProject_WithFilter(t *testing.T) {
	...
	var summaries []Summary
	err := engine.NewQuery[AggProduct](db, where.Field("category").Eq("X")).Project(ctx, &summaries)
	require.NoError(t, err)
...
func TestGroupBy_CacheHit(t *testing.T) {
	...
	var stats1 []CatStats
	require.NoError(t, engine.NewQuery[AggProduct](db).GroupBy("category").Into(ctx, &stats1))
	require.Len(t, stats1, 2)

	// Second call with same target type — should hit cache
	var stats2 []CatStats
	require.NoError(t, engine.NewQuery[AggProduct](db).GroupBy("category").Into(ctx, &stats2))
...
func TestProject_InvalidTarget(t *testing.T) {
	...
	err := engine.NewQuery[AggProduct](db).Project(ctx, &single)
	require.Error(t, err)
}
...
func TestQuerySet_Count(t *testing.T) {
	...
	count, err := engine.NewQuery[AggProduct](db, where.Field("category").Eq("Y")).Count(ctx)
	require.NoError(t, err)
